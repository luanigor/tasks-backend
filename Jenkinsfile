pipeline{
    ...
    post {
        always {
            ...
            archiveArtifacts artifacts: 'target/tasks-backend.war, frontendtarget/tasks.war', onlyIfSuccessful: true
        }
        unsuccessful{
            emailext attachLog: true, body: 'See the attached log below', subject: 'Build $BUILD_NUMBER has failed', to: 'luanzinbh@gmail.com'
        }
        fixed{
            emailext attachLog: true, body: 'See the attached log below', subject: 'Build is fine!!!', to: 'luanzinbh@gmail.com'
        }
    }
}